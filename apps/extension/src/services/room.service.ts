 ...
 */
import type { ConnectionStatus, Room, User, CreateRoomPayload, JoinRoomPayload } from '../types/index.js';
...
async function sendToBg<T>(type: string, payload?: unknown): Promise<BgResponse<T>> {
...
export const roomService = {
  ...
  async getRoomState(): Promise<BgResponse<{ room: Room | null; user: User | null; status: ConnectionStatus }>> {
