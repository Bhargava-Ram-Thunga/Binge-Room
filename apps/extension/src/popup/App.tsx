    ...
    const handler = (msg: {
      ...
      if (msg.type === "ROOM_UPDATE") {
        ...
        if (msg.payload.user !== undefined)
          store.setCurrentUser(msg.payload.user ?? null);
        setView("home");
        store.setError(null);
      }
      if (msg.type === "CONNECTION_STATUS")
        store.setConnected(msg.payload.connected ?? false);
      if (msg.type === "ERROR")
        store.setError(msg.payload.message ?? "Something went wrong");
    };
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          border: `1px solid ${connected ? "rgba(34,197,94,.25)" : "rgba(239,68,68,.25)"}`,
        }}
      >
        <span
          ...
          style={{
            ...
            boxShadow: connected ? "0 0 0 0 rgba(34,197,94,.5)" : "none",
    ...
    <div className="animate-fadeSlideUp" style={{ paddingTop: 20 }}>
      ...
      <div className="text-center mb-6">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg,rgba(99,102,241,.2),rgba(168,85,247,.2))",
